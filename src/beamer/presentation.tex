...
\begin{frame}
  ...
  %\begin{center}
    \begin{tabular}{cccc}
      ...
      \includegraphics[scale=0.25]{src/beamer/figures/s1.jpg} & \includegraphics[scale=0.25]{src/beamer/figures/s1_proj.jpg} & 1210 & 4630 \\[1ex]
      \onslide<3->{\includegraphics[scale=0.25]{src/beamer/figures/not_a_face.jpg} & \includegraphics[scale=0.25]{src/beamer/figures/not_a_face_proj.jpg} & 8088 & 6828}
    \end{tabular}    
  %\end{center}
\end{frame}
